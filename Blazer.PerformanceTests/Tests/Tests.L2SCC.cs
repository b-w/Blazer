namespace Blazer.PerformanceTests.Tests
{
    ...
    public class L2SCCSingleSelectManyTimesTest : TestBase
    {
        L2SModelDataContext m_ctx;
        readonly int m_count;

        public L2SCCSingleSelectManyTimesTest(int count) : base($"Linq2SQL (change tracking): SELECT 1 record, {count:N0} times")
        {
            m_count = count;
        }
