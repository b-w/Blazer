namespace Blazer.PerformanceTests.Tests
{
    ...
    public class EFSmallSelectTest : TestBase
    {
        ...
        public EFSmallSelectTest() : base("EF v6.1.3: SELECT 500 records")
        {
        }
    ...
    public class EFLargeSelectTest : TestBase
    {
        ...
        public EFLargeSelectTest() : base("EF v6.1.3: SELECT 5.000 records")
        {
        }
    ...
    public class EFHugeSelectTest : TestBase
    {
        ...
        public EFHugeSelectTest() : base("EF v6.1.3: SELECT 50.000 records")
        {
        }
