namespace Blazer.Caching
{
    ...
    internal static class ParameterFactoryCache
    {
        ...
        public static bool TryGet(string key, out ParameterFactoryFuncFormattableString factory)
        {
            return m_factoryCacheFormattableString.TryGetValue(key, out factory);
        }

        public static void Add(string key, ParameterFactoryFuncFormattableString value)
        {
            m_factoryCacheFormattableString.AddOrUpdate(key, value, (k, old) => value);
        }
#endif
